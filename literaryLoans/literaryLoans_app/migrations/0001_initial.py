    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borrower_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='book_borrower', to=settings.AUTH_USER_MODEL)),
                ('lender_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_lender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
